...
async def single_link(_, message):
    ...
    try:
        ...
        if data and data.get("session"):
            ...
            try:
                device = "Poco C65 Team SPY"
                userbot = Client(":userbot:", api_id=API_ID, api_hash=API_HASH, session_string=session, device_model=device, workers=50, max_concurrent_transmissions=45)
                await userbot.start()                
            except:
